...
curl -X POST -H 'Content-type: application/json' --data "$object_right" https://hooks.slack.com/services/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
...
curl -X POST -H 'Content-type: application/json' --data "$object_wrong" https://hooks.slack.com/services/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
