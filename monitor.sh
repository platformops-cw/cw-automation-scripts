...
curl -X POST -H 'Content-type: application/json' --data "$object_right" https://hooks.slack.com/services/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
...
curl -X POST -H 'Content-type: application/json' --data "$object_wrong" https://hooks.slack.com/services/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
